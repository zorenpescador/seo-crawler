...
health_score.py implements 45 checks directly (see CHECK_NAME_TO_CATALOG_ID
there for the full list — spread across checks/on_page.py, checks/markup.py,
checks/performance.py, checks/links.py, and checks/mobile.py) plus the
aggregate score/category-scores/quick-wins rows (C136, C137, C139). The
remaining 90 checks in checks_catalog.csv have a placeholder function
