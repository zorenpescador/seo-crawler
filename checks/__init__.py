...
health_score.py implements 31 checks directly (see CHECK_NAME_TO_CATALOG_ID
...
ratio checks in checks/on_page.py, plus the missing-favicon-link check in
checks/markup.py) plus the aggregate score/category-scores/quick-wins
rows (C136, C137, C139). The remaining 104 checks in checks_catalog.csv
