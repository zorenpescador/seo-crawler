...
health_score.py implements 34 checks directly (see CHECK_NAME_TO_CATALOG_ID
...
checks/markup.py; and the images-missing-dimensions check in
checks/performance.py) plus the aggregate score/category-scores/
quick-wins rows (C136, C137, C139). The remaining 101 checks in
