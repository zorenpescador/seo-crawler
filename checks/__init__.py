...
health_score.py implements 35 checks directly (see CHECK_NAME_TO_CATALOG_ID
...
checks/markup.py; and the images-missing-dimensions and excessive-dom-
size checks in checks/performance.py) plus the aggregate score/
category-scores/quick-wins rows (C136, C137, C139). The remaining 100
checks in checks_catalog.csv have a placeholder function here, grouped
